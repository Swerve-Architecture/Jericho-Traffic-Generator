...
class STLS1(object):
    ...
    def create_stream (self):
        ...
        #                                 packet  = STLPktBuilder(pkt=Ether()/IP(src="16.0.0.1",dst="48.0.0.1")/TCP(dport=12,sport=1025)/(10*'x')),
        #                                 mode    = STLTXCont() ),

        #                      STLStream( name    = 'S1',
        #                                 packet  = STLPktBuilder(pkt=Ether()/IP(src="192.0.0.1",dst="48.0.0.1")/TCP(dport=12,sport=1045)/(10*'y')),
        #                                 mode    = STLTXCont() ),

        #                      STLStream( name    =  'S2',
        #                                 packet  = STLPktBuilder(pkt=Ether()/IP(src="10.0.0.1",dst="48.0.0.1")/TCP(dport=12,sport=1065)/(10*'z')),
        #                                 mode    = STLTXCont() )
        #                     ]).get_streams()
